    ...
    function create$toolbar() {
        ...
        $.each(toolbar.obj_plugins, function(a, b, c) {
            ...
            if (options.theme) {
                ...
                html = $('<div class="tb_button" plugin-key="' + 'save' + '"><img src=' + toolbar.icon_base + ('save' + '.png') + ' ></div>')
                //end HC
            } else {
                ...
                html = $('<div style="' + style +
                '"><div style=display:none;font-size:10px;font-family:arial;text-align:center>' + 'save' + '</div><img class=tb_button plugin-key="' + 'save' + '"src=' + toolbar.icon_base + ('save' + '.png') + ' ></div>')
                //end HC
